...
angular.module('appDirectives').directive('calendar', [function () {

    var MONTHNAMES = ["一","二","三","四","五","六","七","八","九","十","十一", "十二"];
    var DAYNAMES = ["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday", "Saturday"];

    //包装成类有助于脱离angular时，分离代码。
    ...
    Calendar.prototype = {
        ...
        clickDate: function (event) {
            ...
            if (this.click) {
                this.click({date: target.data('date')});
            }
            this.scope.$apply();
        }
    };
    ...
    return {
        ...
        link: function (scope, element, attrs) {
            ...
            scope.$watch('date', function (newVals, oldVals) {
                var date = new Date(newVals);
                scope.calendar.update(date);
            });
